            ...
            <View style={styles.statusItem}>
              <View
                style={[
                  styles.statusDot,
                  {
                    backgroundColor: terminalStatus.initialized
                      ? "#238636"
                      : "#f85149",
                  },
                ]}
              ...
              <Text style={styles.statusText}>
                Alpine Linux:{" "}
                {terminalStatus.initialized ? "Ready" : "Initializing"}
              </Text>
            </View>
            ...
            <View style={styles.statusItem}>
              <View
                style={[
                  ...
                  {
                    backgroundColor:
                      terminalStatus.serverStatus.status === "running"
                        ? "#238636"
                        : "#7d8590",
                  },
                ]}
        ...
        <View style={styles.loadingOverlay}>
          <View style={styles.loadingContent}>
            ...
            <View style={styles.loadingSteps}>
              ...
              <Text style={styles.loadingStep}>✅ Creating environment</Text>
              <Text style={styles.loadingStep}>
