...
export class BridgeDebugger {
  static debugBridgeRegistration(): void {
    ...
    const possibleNames = [
      'ExpoTermux',              // Our new standard name
      'TermuxCore',              // Legacy name
      'ExpoTermuxCore', 
      'expo_modules_expotermux_ExpoTermuxModule',  // Possible autogenerated name
      'ExpoModulesExpotermuxExpoTermuxModule',
      'TermuxCoreModule',
