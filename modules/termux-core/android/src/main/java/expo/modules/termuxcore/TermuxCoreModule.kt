...
class TermuxCoreModule : Module() {
    ...
    override fun definition() = ModuleDefinition {
        ...
        OnCreate {
            ...
            // Disable native implementation until Termux modules are properly available
        ...
        AsyncFunction("createSession") { 
            ...
            try {
                // Always use fallback implementation until Termux modules are available
                if (false) {
                    // Native implementation disabled
                    promise.reject("NATIVE_DISABLED", "Native implementation disabled", null)
                } else {
    ...
    // Removed native output monitoring function - using fallback only
